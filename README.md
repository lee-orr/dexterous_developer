...
Install the CLI by running: ```cargo install dexterous_developer_cli@0.4.0-alpha.1```. This installs 2 command line utilities:
...
[dependencies]
bevy = "0.14"
bevy_dexterous_developer = { version = "0.4.0-alpha.1"}
